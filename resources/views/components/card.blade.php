<div class="container items-center px-6 mt-5">
    <div class="flex flex-wrap mx-0 max-w-6xl lg:max-w-full">     
        <div class="w-full p-2 w-1/4">
            <div class="flex flex-col px-6 py-4 overflow-hidden bg-white hover:bg-gradient-to-br hover:from-purple-400 hover:via-blue-400 hover:to-blue-500 rounded-xl shadow-lg duration-300 hover:shadow-2xl group">
                ...
                <h1 class="text-2xl font-bold text-gray-700 mt-8 group-hover:text-gray-50">42.34k</h1>
